  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 px-6">
      <div className="max-w-4xl mx-auto text-center">
        <h1 className="text-5xl md:text-6xl font-semibold text-white dark:text-gray-100 mb-6">
          Hi, I'm Vinisha Sahoo.
        </h1>
        <p className="text-xl md:text-2xl text-gray-200 dark:text-gray-300 mb-6">
          Computer Science & AI/ML Student building practical software and intelligent systems.
        </p>
        <p className="text-base text-gray-300 dark:text-gray-400 mb-10 max-w-2xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12">
          ...
          <button
            ...
            className="px-8 py-3 border border-gray-400 dark:border-gray-600 text-white dark:text-gray-200 rounded-lg font-medium hover:bg-gray-800 dark:hover:bg-gray-700 transition-colors"
          >
            Let's Connect
          </button>
        </div>
